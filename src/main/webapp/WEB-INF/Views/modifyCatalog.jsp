                ...
                <div class="vehicle">
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            <img src="Q5.jpg" class="img-responsive center-block" alt="vehicleImage" id="modal-vehicleImage">
                        </div>
                    </div>
...
<center>
    <img src="ModifyVehicle.jpg" alt="Search for a vehicle in the catalog">
</center>
<center>
...
<c:choose>
    <c:when test="${not empty modifyCatalogfound}">
        <c:choose>
            <c:when test="${modifyCatalogfound eq 'RESULT_FOUND'}">
                <center>
                    <h3>
                        Results <span class="label label-default">${modifyCatalogresults.size()}</span>
                    </h3>
                </center>
