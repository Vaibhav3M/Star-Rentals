...
public interface IVehicleTDG {
    ...
    public boolean addNewVehicle(String type,int year, String model,String color,String licenseNumber, String status,String image, String make) throws Exception;

    public boolean deleteVehicle(String licenseNumber) throws Exception;

    public boolean modifyVehicle(String type,int year, String model,String make, String color,String licenseNumber, String status,String image) throws Exception;
